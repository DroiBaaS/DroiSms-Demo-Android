...
public class VerifyActivity2 extends FragmentActivity implements OnDroiSmsFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (smsFragment == null) {
            smsFragment = DroiSmsFragment.newInstance("18516673469", "template2", false);
